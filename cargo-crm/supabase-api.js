...
const SB_TO_GAS_PKG = {
    ...
    verified_by:         'Ким перевірено',
    verified_at:         'Дата переходу в перевірку',
    verified_source:     'Джерело перевірки',
...
// ================================================================
let _UI_PREFS_CACHE = null; // null до першого load'у; потім завжди об'єкт
